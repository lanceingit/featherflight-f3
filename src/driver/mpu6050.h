...
{
public:
    MPU6050(enum Rotation rotation);
...
//    
//    float get_accx() {return _acc[0];}
//    float get_accy() {return _acc[1];}
//    float get_accz() {return _acc[2];}

//    float get_gyrox() {return _gyro[0];}
//    float get_gyroy() {return _gyro[1];}
//    float get_gyroz() {return _gyro[2];}
